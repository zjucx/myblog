...
const state = {
  articles: [{"title":"qqqqq","tags":[{"name":"node"},{"name":"node"},{"name":"node"}]},
             {"title":"qqqqq","tags":[{"name":"node"},{"name":"node"},{"name":"node"}]}],
  title: '',
  article: {"title":"qqqqq","tags":[{"name":"node"},{"name":"node"},{"name":"node"}]},
  tags: [],
  // time: '',
  comments: [],
  author: ''
